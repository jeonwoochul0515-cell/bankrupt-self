...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const features = [
        ...
        { icon: 'fa-map-marker-alt', title: '지역별 법원 특화 정밀 진단', description: '각 지역 회생법원의 최신 실무 준칙과 특수성을 알고리즘에 녹여내어, 다른 곳에서는 볼 수 없는 맞춤형 분석 결과를 제공합니다.' },
        { icon: 'fa-robot', title: 'AI 기반 1분 완성 시뮬레이션', description: '복잡한 정보 입력 없이, 몇 가지 핵심 질문만으로 개인회생 신청 자격부터 예상 탕감액까지 1분 안에 명쾌하게 확인할 수 있습니다.' },
        { icon: 'fa-shield-alt', title: '철저한 개인정보 보호', description: '모든 진단 데이터는 저장되지 않으며, 원하실 경우 언제든지 직접 모든 기록을 삭제할 수 있어 안심하고 이용할 수 있습니다.' }
    ];
    ...
    const reviews = [
        { stars: 5, text: '막막하기만 했는데, 여기서 진단받고 희망을 얻었습니다. 월 변제금이 생각보다 훨씬 적게 나와서 바로 전문가 상담을 신청했어요. 정말 감사합니다.', author: '김OO / 서울시 강남구' },
        { stars: 5, text: '코인 투자 실패로 빚더미에 앉았을 때 정말 절망적이었습니다. 제 상황에 맞춰 변제금을 최소화하는 방법을 찾을 수 있어 다행이었어요.', author: '박XX / 경기도 성남시' },
        { stars: 5, text: '여러 곳 알아봤는데 여기가 제일 계산이 정확하고 빨랐어요. 1분 만에 결과가 나오는 게 신기하네요. 덕분에 빠르게 결정할 수 있었습니다.', author: '이OO / 부산시 해운대구' },
        { stars: 5, text: '혹시나 기록에 남을까 봐 걱정했는데, 개인정보 보호가 철저하다고 해서 안심하고 이용했습니다. 망설이시는 분들께 강력 추천합니다!', author: '최XX / 인천시 연수구' }
    ];
