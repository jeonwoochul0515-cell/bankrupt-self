...
- [x] `guide.html` 작성 — 부산 개인회생 완벽 가이드 (자격/변제금/기간/비용/절차/서류/2026변경점) + Article·BreadcrumbList JSON-LD
- [x] `sitemap.xml`에 /guide 등록 + 메인 lastmod 갱신
- [x] `index.html` footer에 가이드 내부 링크 추가
- [x] JSON-LD 유효성 검증 통과
